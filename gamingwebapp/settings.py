"""
Django settings for gamingwebapp project.
...
ROOT_URLCONF = 'gamingwebapp.urls'
...
WSGI_APPLICATION = 'gamingwebapp.wsgi.application'
...
# Searches the folder static on the base_dir
"""
STATICFILES_DIRS = [
